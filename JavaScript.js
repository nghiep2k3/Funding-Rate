...
button.addEventListener("click", () => {
  ...
  //Đầu vào 2 số âm
    if (Profit_A < 0 && Profit_B < 0) {
      console.log(111);
      const Total1 = parseFloat(Math.abs(Profit_A - Profit_B)).toFixed(8) - parseFloat(Total_Fee);
  ...
  // Đầu vào 2 cái trái dấu với A < 0 && B > 0
    if (Profit_A > 0 && Profit_B < 0 || Profit_A < 0 && Profit_B > 0 ) {
      ...
      const Total3 = (parseFloat(Profit_A_abs) + parseFloat(Profit_B_abs)) - parseFloat(Total_Fee);
